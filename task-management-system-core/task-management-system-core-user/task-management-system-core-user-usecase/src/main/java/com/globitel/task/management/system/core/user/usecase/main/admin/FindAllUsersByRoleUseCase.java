...
public class FindAllUsersByRoleUseCase extends ValidatorFunctionalUseCase<List<FindAllUsersResponse>, FindAllUsersByRequest> {

    private final UserDao  userDao;

    public FindAllUsersByRoleUseCase(Validator validator, UserDao userDao) {
        super(validator);
    ...
    protected List<FindAllUsersResponse> doExecute(FindAllUsersByRequest request) {
        return userDao.findAllByUserRole(UserRole.valueOf(request.filter()))
                .stream()
